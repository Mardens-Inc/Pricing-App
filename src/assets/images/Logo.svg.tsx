...
export default function Logo(props: logoIconProperties)
{
    return (
        <svg width={props.size || props.width || "106"} height={props.size || props.height || "106"} viewBox="0 0 106 106" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M53 3L96.3013 28V78L53 103L9.69873 78V28L53 3Z" fill="hsla(var(--nextui-primary), 70%)"/>
            <path fillRule="evenodd" clipRule="evenodd" d="M53 8.7735L14.6987 30.8868V75.1133L53 97.2265L91.3013 75.1133V30.8868L53 8.7735ZM96.3013 28L53 3L9.69873 28V78L53 103L96.3013 78V28Z" fill="hsl(var(--nextui-primary))"/>
            <path
